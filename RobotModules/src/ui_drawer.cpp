...
bool UiDrawer::encodeChassisWorkStateContent(uint8_t* data_ptr, size_t& data_len, UiDrawer::GraphicOperation opt)
{
  ...
  if (chassis_work_state_ != PwrState::kWorking) {
    ...
    str = Chassis::WorkingModeToStr(chassis_working_mode_) + "-" + CtrlModeSrcToStr(chassis_ctrl_mode_, chassis_manual_ctrl_src_);
  }
...
bool UiDrawer::encodeGimbalWorkStateContent(uint8_t* data_ptr, size_t& data_len, UiDrawer::GraphicOperation opt)
{
  ...
  if (gimbal_work_state_ != PwrState::kWorking) {
    ...
    str = Gimbal::WorkingModeToStr(gimbal_working_mode_) + "-" + CtrlModeSrcToStr(gimbal_ctrl_mode_, gimbal_manual_ctrl_src_);
  }
...
bool UiDrawer::encodeShooterWorkStateContent(uint8_t* data_ptr, size_t& data_len, UiDrawer::GraphicOperation opt)
{
  ...
  if (shooter_work_state_ != PwrState::kWorking) {
    ...
    str = Shooter::WorkingModeToStr(shooter_working_mode_) + "-" + CtrlModeSrcToStr(shooter_ctrl_mode_, shooter_manual_ctrl_src_);
  }
